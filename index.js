...
// when we define one function with in the an another function the inner function has access to outer function as well as global scope variables and this is called lexical scope function
// we see that internal variable is defined in the outer function myFunction and nested function that is inside has access to outer function variables.
...
// we can give any array as a parameter
  ...
  */
  ...
  function consume(a,b,cb){           // a ,b are parameter and cb is the callback function and consume is the higher order function.
   return cb(a,b)
  }
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
console.log(cuboid.volume()); // 100            //yay it work
...
//   height: 2
// })
// console.log(cuboidchild.cubeSurfaceArea())   // i should get 24 here
// console.log(cuboidchild.cubeVolume())         // i should get 8 here
